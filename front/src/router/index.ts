...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/locker', name: 'locker', component: InventoryView, meta: { requiresAuth: true, title: 'Locker' } },
    { path: '/inventory', name: 'inventory', redirect: { name: 'locker' }, meta: { requiresAuth: true } },
